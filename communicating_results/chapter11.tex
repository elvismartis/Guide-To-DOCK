...
\begin{itemize}
  \item 3D views of ligand poses in the binding pocket, 
  \item 2D interaction diagrams, 
...
\begin{itemize}
  ...
  \item Provide sufficient methodological detail on receptor and ligand preparation, software, parameters, scoring to ensure reproducibility.
  \item Describe validation procedures, such as redocking, cross-docking, enrichment, and report standard metrics such as RMSD and enrichment factors.
