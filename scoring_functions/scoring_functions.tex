...
RF-Score-VS extends this idea to virtual screening tasks, training on large numbers of active/decoy complexes (e.g., DUD-E) and optimizing enrichment metrics.\cite{CH3_Wojcikowski2017_RFScoreVS} Related work has shown that ML scoring functions can substantially improve virtual screening hit rates relative to classical scoring functions, but are sensitive to training/test similarity and dataset biases.\cite{CH3_CH3_li2021machine,CH3_CH3_li2017structural}
